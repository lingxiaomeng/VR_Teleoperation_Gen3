...
public class PlaneDetection : MonoBehaviour
{
    ...
    void plane_detection_callback(PlaneDetectionResponse response)
    {
        ...
        this.transform.SetParent(camera_color_frame, false);
        this.transform.SetLocalPositionAndRotation(camera_color_frame.position, camera_color_frame.rotation);
    }
}
